...
survivor = {
	captain = {
		...
		endQuote = "..and so he left, with a tale for the grave.",
...
skill = {
	captainZ = {
			name = "Vulcan Shotgun",
			description = "Fire a blast of pellets for up to <y>6x65% damage</c>. Charging the attack narrows the <b>spread</c> and increases <b>range and knockback</c>."
		},
	captainX = {
			name = "Power Tazer",
	...
	captainC_1 = {
			name = "Orbital Probe",
			description = "Request an Orbital Probe, each dealing <y>500% damage</c> and <y>stunning</c>."
		},
	captainC_2 = {
	...
	captainBeaconPunisher = {
			...
			description = "Nearby allies gain <y>10% bonus damage</c>.\nBonus increases by <y>6%</c> based on the <y>number of enemies this beacon hits</c> on impact."
		},
...
achievement = {
	captainUnlockChar = {
		name = "Wanderlust",
		description = "Beat 10 stages in one run."
		},
	-- captainPrism = {
		-- name = "Strange Prism: Estranged",
		-- description = "Found this prism in the world."
		-- },
	captainHackUnlock = {
		name = "Business Venture",
		description = "Captain: Purchase a total of 7 Armory Chests while on the final stage."
		},
	captainResUnlock = {
		name = "Resourceful",
		description = "Captain: Finish 3 stages in a row holding a different Equipment each time."
		},
	captainUpUnlock = {
		name = "Upgrades, People!",
		description = "Captain: Upgrade drones a total of 14 times."
		},
	captainPunUnlock = {
		name = "Straightened Out",
		description = "Captain: Kill 5 Black Imps simultaneously with an Orbital Probe."
		},
	captainTenna = {
		name = "Prime Time",
		description = "Captain: Use Captain's Brooch a total of 10 times."
		},	
	captainMastery = {
		name = "Captain: Mastery",
		description = "Captain: Beat the game on Monsoon difficulty or higher."
		},
	unlock_captain_skin_p = {
	...
	ui = {
		options = {
			CaptainReturns = {
				...
				captainAutofire = "Vulcan Shotgun Rapid Fire",
				["captainAutofire.desc"] = "Whether holding the skill to full charge should automatically fire it.\nDisabled by default.",
				captainForceUnlock = "Force Unlock Captain",
				["captainForceUnlock.desc"] = "Immediately Unlocks Captain when pressed.\nAlso Re-locks Captain if he's already unlocked.",
				captainDoJudgeTip = "Toggle Judgement Tip",
				["captainDoJudgeTip.desc"] = "Displays a tip about a change in Captain's Kit at the beginning of his Judgement Trial.\nEnabled by default."
	...
	misc = {
		text1 = "Beacons no longer restock after each stage.",
		text2 = "Use them wisely."
	}
}
